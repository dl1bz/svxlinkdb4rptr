...
- I develop this Dashbaord with Raspian light Bullseye/Debian11 and lighttpd as webserver with enabled PHP support 7.x, **PHP >= 8.x NOT supported** at this time ! **I prepare a new version, which will be running with PHP8 too**. Please be patient for that.
