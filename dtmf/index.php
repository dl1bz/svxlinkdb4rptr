...
// Defined buttons:
    ...
    {
        shell_exec('echo "*91260#" > ".$dtmfctrl." 2>&1');
    }

   if (isset($_POST['button2']))
    {
        shell_exec('echo "*912600#" > ".$dtmfctrl." 2>&1');
    }

 if (isset($_POST['button3']))
    {
        shell_exec('echo "*9126078#" > ".$dtmfctrl." 2>&1');
    }

 if (isset($_POST['button4']))
    {
        shell_exec('echo "*91999#" > ".$dtmfctrl." 2>&1');
    }

 if (isset($_POST['button5']))
    {
        shell_exec('echo "9191#" > ".$dtmfctrl." 2>&1');
    }

 if (isset($_POST['button6']))
    {
        shell_exec('echo "9126021#" > ".$dtmfctrl." 2>&1');
    }

 if (isset($_POST['button7']))
    {
        shell_exec('echo "9126062#" > ".$dtmfctrl." 2>&1');
    }

 if (isset($_POST['button8']))
    {
        shell_exec('echo "910#" > ".$dtmfctrl." 2>&1');
    }
...
if (isset($_POST['button9']))
 ...
 if (isset($_POST['button11']))
    {
        shell_exec('echo "*2# 453582#" > ".$dtmfctrl." 2>&1');
    }

 if (isset($_POST['button12']))
    {
        shell_exec('echo "2# 871657## " > ".$dtmfctrl." 2>&1');
    }
